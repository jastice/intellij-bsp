...
import org.jetbrains.plugins.bsp.data.BspProjectDataService._
import org.jetbrains.plugins.bsp.project.{JdkByHome, SdkReference, SdkUtils}
...
object BspProjectDataService {
  ...
  private def setLanguageLevel(projectJdk: Option[Sdk], project: Project) = {
  ...
  private def executeProjectChangeAction(action: => Unit)(implicit project: Project): Unit =
