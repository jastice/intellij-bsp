...
import org.jetbrains.plugins.bsp.{BspBundle, _}
import org.jetbrains.plugins.bsp.protocol.BspNotifications._
import org.jetbrains.plugins.bsp.protocol.session.BspSession._
...
import org.jetbrains.plugins.bsp.{BSP, BspBundle, BspError}
...
class BspSession private(bspIn: InputStream,
  ...
  private[protocol] def shutdown(error: Option[BspError] = None): Future[Unit] = {
    import org.jetbrains.plugins.bsp.util.extensions.executionContext.appExecutionContext
